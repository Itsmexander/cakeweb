...
//    public void addProduct1(String id, String name, int weight, int price , int amount){
...
//    }
    ...
    public void addProduct1(UUID id, String name, int weight, int price, int amount) {
        products.put(name , new Cakes(id, name, weight, price, amount));
    }
}
